...
<body>
     ...
     <div class="container">
        ...
        <div class="main">
            ...
            <thead>
            <tr> 
            <th><font face="Arial">PASSENGER EMAIL</font> </th>
            <th> <font face="Arial">DEPART FROM</font> </th>
            <th><font face="Arial">DESTINATION</font></th>
            <th><font face="Arial">DEPART DATE</font></th>
            <th><font face="Arial">NUMBER OF TICKETS</font></th>
            <th><font face="Arial">SET PRICE</font></th>
         </tr>
         </thead>';
            ...
            {
            echo "<tr><td>".$row['EMAIL']."</td>"."<td>".$row['LEAVING']."</td>"." <td>".$row['DESTINATION']."</td>"."<td>".$row['DEPARTDATE']."</td>"."<td>".$row['NTICKETS']."</td>"."<td>".$row['TOTALPRICE']."</td>"."</tr>";
            }
