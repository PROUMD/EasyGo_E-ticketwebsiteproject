...
<body>
     ...
     <div class="container">
        ...
        <div class="main">
            ...
            <thead>
            <tr> 
            <th><font face="Arial">ROUTE NUMBER</font> </th>
            <th> <font face="Arial">ROUTE NAME</font> </th>
            <th><font face="Arial">CURRENT LOCATION</font></th>
            ...
            {
            echo "<tr><td>".$row['RouteNumber']."</td>"."<td>".$row['RouteName']."</td>"." <td>".$row['CurrentLocation']."</td>"."<td>".$row['Destination']."</td>"."</tr>";
            }
